...
def gen_grid_data(zero_ecc_chirp, param_vals, MA_vals, n, fid_e_vals, q, f_low, max_e, approximant='TEOBResumS'):
    ...
    for fid_e in fid_e_vals:
        ...
        all_matches[fid_e] = chirp_match_MA_grid_data(e_vals, MA_vals, n, fid_e, zero_ecc_chirp, q, f_low, harm_ids, approximant=approximant)
        end = time.time()
...
if __name__ == "__main__":
    ...
    gen_grid_data(24, np.linspace(0, 20/3, 201), np.linspace(0, 2*np.pi, 32, endpoint=False), 4, np.linspace(0.035, 0.085, 11), 2, 10, 0.5, approximant='TEOBResumS')
