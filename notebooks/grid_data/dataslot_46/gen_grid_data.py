...
if __name__ == "__main__":
    ...
    gen_grid_data([10, 0.035], np.linspace(0, 0.5, 201), np.linspace(0, 2.5*np.pi, 40, endpoint=False), 4, 6, np.linspace(0.0730036413528654, 0.0730036413528654, 1), 2, 10, approximant='TEOBResumS')
