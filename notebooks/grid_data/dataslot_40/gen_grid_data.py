...
def gen_grid_data(zero_ecc_chirp, e_vals, MA_vals, n, fid_e_vals, q, f_low, approximant='TEOBResumS'):
...
if __name__ == "__main__":
    ...
    gen_grid_data(24, np.linspace(0, 0.5, 201), np.linspace(0, 2.5*np.pi, 40, endpoint=False), 6, np.linspace(0.025, 0.07, 10)*(24/10)**(5/6), 2, 10, approximant='TEOBResumS')
