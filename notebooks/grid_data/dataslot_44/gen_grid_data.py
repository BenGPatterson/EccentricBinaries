...
def gen_grid_data(scaling_norms, e_vals, MA_vals, n, fid_e_vals, q, f_low, approximant='TEOBResumS'):
...
if __name__ == "__main__":
    ...
    gen_grid_data([10, 0.035], np.linspace(0, 0.5, 201), np.linspace(0, 2.5*np.pi, 40, endpoint=False), 4, [0.07300364, 0.0732134 , 0.07342304, 0.07363257, 0.07384197, 0.07405125], 2, 10, approximant='TEOBResumS')
