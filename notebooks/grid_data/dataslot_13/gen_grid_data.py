...
def chirp_match_MA_grid_data(param_vals, MA_vals, n, fid_e, fid_M, q, f_low, approximant='TEOBResumS'):
    ...
    for e, chirp in zip(e_vals, chirp_vals):
        ...
        s_e_vals = shifted_e_exact(s_f_vals, f_low, e)
...
if __name__ == "__main__":
    ...
    gen_grid_data(np.linspace(20, 30, 2), np.linspace(0,0.5,201), np.linspace(0, 2*np.pi, 32, endpoint=False), 4, 0.1, 2, 10, approximant='TEOBResumS')
