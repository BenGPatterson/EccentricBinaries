...
if __name__ == "__main__":
    ...
    gen_grid_data([10, 0.035], np.linspace(0, 0.5, 201), np.linspace(0, 2.5*np.pi, 40, endpoint=False), 4, 6, [0.07281324, 0.0726792, 0.07322072, 0.07365994], 2, 10, approximant='TEOBResumS')
