...
if __name__ == "__main__":
    ...
    # Data settings
    true_dict = {'ecc10sqrd': 0.3**2, 'chirp_mass': 16, 'symmetric_mass_ratio': 3/16, 'chi_eff': -0.1}
    init_guess = {'ecc10sqrd': 0, 'chirp_mass': 17, 'symmetric_mass_ratio': 0.20, 'chi_eff': 0.1}
    target_snr = 20
    t_bounds = [-0.05,0.05]
    f_low = 20
    sample_rate = 4096
