...
def plot_SNR2ecc(match_grid, samples_e, samples_SNR, prior_e, prior_SNR, likeL_SNR, true_e=None, meas_SNR=None, e_max=0.4, two_ecc_harms=True):
    ...
    max_interp = interp1d(e_vals, max_line, bounds_error=False, fill_value='extrapolate')
    min_interp = interp1d(e_vals, min_line, bounds_error=False, fill_value='extrapolate')
