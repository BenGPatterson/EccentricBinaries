...
if __name__ == "__main__":
    ...
    gen_e_sqrd_chirp_data([0.05, 0.1, 0.2], [10, 24, 50], np.sqrt(np.linspace(0, 0.5**2, 11)), [np.linspace(9.1,10.1,11), np.linspace(21,25,11), np.linspace(44,56,11)], 4, 2, 10, approximant='TEOBResumS')
