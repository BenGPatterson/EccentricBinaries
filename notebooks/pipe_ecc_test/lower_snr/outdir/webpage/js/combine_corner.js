...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['simple_pe'] = ['chirp_mass', 'symmetric_mass_ratio', 'ra', 'dec', 'luminosity_distance', 'theta_jn', 'psi', 'phase', 'chi_p', 'log_likelihood', 'a_1', 'a_2', 'redshift', 'mass_ratio', 'mass_1', 'mass_2', 'total_mass', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'chi_eff'];
    ...
    var data = {}
    data['simple_pe'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
