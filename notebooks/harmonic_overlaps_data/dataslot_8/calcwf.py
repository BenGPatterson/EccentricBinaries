...
def get_comp_shifts(f_low, e, M, q, n, sample_rate, approximant, h, regen_shift=True):
    ...
    if regen_shift and e > 0:
        ...
        # If waveform too short to find enough peaks
        except:
            s_factor = 1
...
def get_h(coeffs, f_low, e, M, q, sample_rate, approximant='TEOBResumS', f_match=20, subsample_interpolation=True, GS_normalisation=True, regen_shift=False, comp_normalisation=False, comp_phase=0, return_ovlps=False):
    """
