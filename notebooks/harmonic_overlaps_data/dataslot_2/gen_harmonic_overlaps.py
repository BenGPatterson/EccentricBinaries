...
if __name__ == "__main__":
    ...
    gen_e_sqrd_chirp_data([0, 0.05, 0.1, 0.15, 0.2], [10, 24, 50], np.sqrt(np.linspace(0, 0.5**2, 151)), [np.linspace(9.4,10.1,51), np.linspace(22,24.5,51), np.linspace(46,51,51)], 4, 20, 2, 10, approximant='TEOBResumS')
